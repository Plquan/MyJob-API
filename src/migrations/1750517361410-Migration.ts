...
export class Migration1750517361410 implements MigrationInterface {
    name = 'Migration1750517361410'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "MyJobFile" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "publicId" character varying(255) NOT NULL, "url" character varying(255) NOT NULL, "fileType" character varying(50) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_dc4674deb5e329febdea4418d7" UNIQUE ("userId"), CONSTRAINT "PK_cc27ede690e0d8b01738bacd7b1" PRIMARY KEY ("id"))`);
